...
export const socialProfiles: Record<string, SocialProfile> = {
  ...
  Twitter: {
    ...
    bio: "Full-Stack Engineer 20 • UI Systems Architect • Building PRIMA",
    location: "Earth",
    stats: [
  ...
  Medium: {
    name: "Josiah De Asis",
    handle: "josiahdeasis009@gmail.com",
    avatar: "https://github.com/VidZid2.png?v=1",
...
export function SocialProfileContent({ socialName, profile }: { socialName: string; profile: SocialProfile }) {
  return (
    <>
        ...
        {isOpen && (
          <HoverCard.Portal forceMount>
            ...
            >
              ...
              >
                <SocialProfileContent socialName={socialName} profile={profile} />
              </motion.div>
            </HoverCard.Content>
          </HoverCard.Portal>
        )}
