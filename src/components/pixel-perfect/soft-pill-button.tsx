      ...
      >
        <span
          ...
          className={cn(
            ...
            isPrimary
              ? "bg-[#6495ED] group-hover:bg-[#5281D6] dark:bg-[#6495ED] dark:group-hover:bg-[#72A0EE] border border-black/10 dark:border-white/10"
        ...
        >
          ...
          <span
            className={cn("absolute inset-0 transition duration-200 group-active:opacity-0 group-active:duration-[50ms]", isPrimary ? "opacity-[0.2]" : "opacity-[0.16] dark:opacity-[0.04]")}
            style={{
              background: "linear-gradient(rgb(255, 255, 255) 0%, rgba(255, 255, 255, 0) 100%)",
            }}
          />
          <span
            className={cn("absolute inset-0 transition duration-200 group-active:duration-[50ms]", isPrimary ? "opacity-[0.1]" : "opacity-[0.04] dark:opacity-[0.1]")}
            style={{
              background:
