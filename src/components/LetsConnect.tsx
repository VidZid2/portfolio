        ...
        >
          <a href="/contact" onClick={(e) => { e.preventDefault(); navigate("/contact"); }} className="block w-full">
            <SoftPillButton
              as="span"
              variant="primary"
              className="w-full justify-center px-2 sm:px-4 py-2 !text-[12px] sm:!text-[13px] hover:scale-[1.03] shadow-[0_4px_16px_rgba(100,149,237,0.3)] dark:shadow-[0_4px_16px_rgba(100,149,237,0.15)] transition-all duration-300"
            >
        ...
        >
          <a href="/contact" onClick={(e) => { e.preventDefault(); navigate("/contact"); }} className="block w-full">
            <SoftPillButton
              as="span"
              variant="secondary"
              className="w-full justify-center px-2 sm:px-4 py-2 !text-[12px] sm:!text-[13px] hover:scale-[1.03] shadow-sm transition-all duration-300"
            >
