...
export interface AnimatedLinkProps extends React.HTMLAttributes<HTMLElement> {
  ...
  return (
    <Component
      className={cn(
        ...
        "before:transition-transform before:duration-300 before:ease-[cubic-bezier(0.4,0,0.2,1)] before:content-['']",
        underlineVariants[variant as AnimatedLinkVariant],
        className,
      )}
      {...props}
    >
