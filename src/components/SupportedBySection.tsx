    ...
    <>
      ...
      >
        ...
        <div className="relative h-[32px] sm:h-[36px] flex items-center justify-center px-8 sm:px-10 text-center">
          ...
          <div className="absolute left-full top-[-22px] sm:top-[-24px] pl-5 sm:pl-6 hidden xl:flex flex-col items-start pointer-events-none select-none z-30 min-w-max">
            <div className="rotate-[3deg] ml-1 text-zinc-700 dark:text-zinc-300">
              <HandwritingText text="extraordinary creators" delay={0.2} duration={1.3} height="30px" strokeWidth={2.0} />
            </div>
            <svg
              className="w-8 h-4 text-zinc-500 dark:text-zinc-400 overflow-visible mt-1 -ml-1"
              viewBox="0 0 28 14"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.4"
