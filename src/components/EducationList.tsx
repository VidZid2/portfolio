...
import { Award, Binary, Layers, ShieldCheck, Sparkles, Code } from "lucide-react";
import { educationList, type EducationBullet, type EducationBadge } from "@/data/educationData";
...
function BouncingEducationBulletList({
  bullets,
  badges,
  isOpen,
}: {
