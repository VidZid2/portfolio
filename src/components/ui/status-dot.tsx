...
const statusDotStateConfig = {
  ...
  ERROR: { tone: "error", label: "Error", animate: true },
  READY: { tone: "success", label: "Ready", animate: true },
  CANCELED: {
    tone: "neutral",
    label: "Canceled",
    animate: false,
...
const statusDotSizeConfig = {
  sm: { dot: 6, container: 14, rippleSpread: "6px" },
  md: { dot: 7, container: 16, rippleSpread: "8px" },
  lg: { dot: 9, container: 22, rippleSpread: "10px" },
} as const satisfies Record<
  StatusDotSize,
