    ...
    >
      ...
      <div className="relative flex flex-col sm:flex-row items-center justify-between py-1 sm:py-1.5 px-3 sm:px-4 gap-2 sm:gap-4 min-h-[44px]">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 text-zinc-600 dark:text-zinc-400">
          ...
          >
            <svg className="w-[23px] h-[23px] sm:w-[25px] sm:h-[25px]" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Separator 1 */}
          <div
            className="w-0 h-[18px] sm:h-[20px] border-r border-black/30 dark:border-white/[0.15] shrink-0 pointer-events-none"
            style={dashedMaskVertical}
          />
          ...
          <motion.a
            ...
            className="hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors flex items-center justify-center shrink-0 p-0.5 outline-none cursor-pointer"
          >
            <motion.svg
              className="w-[34px] h-[34px] sm:w-[38px] sm:h-[38px]"
              viewBox="0 0 14 14"
              fill="currentColor"
              whileHover={{
                scaleY: [1, 1.14, 0.93, 1.05, 1],
                scaleX: [1, 0.94, 1.07, 0.98, 1],
              }}
