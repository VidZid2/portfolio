    ...
    >
      ...
      {expandContentMargins ? (
        <>
          ...
          <div className="absolute h-[2px] w-[2px] bg-black/50 dark:bg-white/[0.3] pointer-events-none z-10 left-3 sm:left-4 md:left-[24.5%] top-[22vh] -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute h-[2px] w-[2px] bg-black/50 dark:bg-white/[0.3] pointer-events-none z-10 right-3 sm:right-4 md:right-[24.5%] top-[22vh] translate-x-1/2 -translate-y-1/2" />
          <div className="absolute h-[2px] w-[2px] bg-black/50 dark:bg-white/[0.3] pointer-events-none z-10 left-3 sm:left-4 md:left-[24.5%] top-[calc(22vh+112px)] -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute h-[2px] w-[2px] bg-black/50 dark:bg-white/[0.3] pointer-events-none z-10 right-3 sm:right-4 md:right-[24.5%] top-[calc(22vh+112px)] translate-x-1/2 -translate-y-1/2" />
          <div className="absolute h-[2px] w-[2px] bg-black/50 dark:bg-white/[0.3] pointer-events-none z-10 left-3 sm:left-4 md:left-6 lg:left-8 top-[calc(22vh+112px)] -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute h-[2px] w-[2px] bg-black/50 dark:bg-white/[0.3] pointer-events-none z-10 right-3 sm:right-4 md:right-6 lg:right-8 top-[calc(22vh+112px)] translate-x-1/2 -translate-y-1/2" />
        </>
      ) : (
        <>
          {/* Vertical side guides — dotted micro-dots */}
          <div
            className="absolute top-0 bottom-0 left-3 sm:left-4 md:left-[24.5%] w-0 border-r border-black/30 dark:border-white/[0.15] pointer-events-none z-30"
            style={DOT_MASK_VERTICAL}
          />
          <div
            className="absolute top-0 bottom-0 right-3 sm:right-4 md:right-[24.5%] w-0 border-r border-black/30 dark:border-white/[0.15] pointer-events-none z-30"
            style={DOT_MASK_VERTICAL}
          />
