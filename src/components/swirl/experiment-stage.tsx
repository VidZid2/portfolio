...
export function ExperimentStage({
  ...
  children?: ReactNode;
  /** Render without borders, rounding, or background for a seamless fit. */
  seamless?: boolean;
}) {
  ...
  return (
    ...
    >
      {failed ? (
        <div className="flex w-full h-full items-center justify-center px-6 text-center text-[12px] text-[var(--text-tertiary)]">
